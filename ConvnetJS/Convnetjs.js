...
// sx * sy * depth number of elements. E.g:
 // contains 1.2
console.log(v.w[1])
console.log(v.dw[0] )// contains 0, because gradients are initialized with zeros
...
console.log(vol3d.set(2,0,1,5.0)); // set coordinate (2,0,1) to 5.0
console.log(vol3d.get(2,0,1)) // returns 5.0
